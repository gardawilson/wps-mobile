...
import 'preview_label_view_model.dart';

class PDFViewModelST extends ChangeNotifier {
            ...
            children: [
                ...
                children: [
                  pw.TableRow(
                    children: [
                      ...
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(4.0),
                        child: pw.Text('${label.dateCreate}', style: pw.TextStyle(fontSize: 18)),
                      ),
                    ],
                  ),
                  pw.TableRow(
                    children: [
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(4.0),
                        child: pw.Text('Plat', style: pw.TextStyle(fontSize: 18)),
                      ),
                      pw.Padding(
                        padding: pw.EdgeInsets.fromLTRB(1, 4, 1, 4), // Kiri: 1, Top: 4, Kanan: 1, Bottom: 4
                        child: pw.Text(':', style: pw.TextStyle(fontSize: 18)),
                      ...
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(4.0),
                        child: pw.Text('${label.noPlat}', style: pw.TextStyle(fontSize: 18)),
                      ),
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(4.0),
                  ...
                  pw.TableRow(
                    children: [
                      ...
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(4.0),
                        child: pw.Text('Stick', style: pw.TextStyle(fontSize: 18)),
                      ),
                      pw.Padding(
                        padding: pw.EdgeInsets.fromLTRB(1, 4, 1, 4), // Kiri: 1, Top: 4, Kanan: 1, Bottom: 4
                        child: pw.Text(':', style: pw.TextStyle(fontSize: 18)),
                      ...
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(4.0),
                        child: pw.Text('${label.namaStickBy}', style: pw.TextStyle(fontSize: 18)),
                      ),
                    ],
                  ),
                  pw.TableRow(
                    children: [
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(4.0),
                        child: pw.Text('Print', style: pw.TextStyle(fontSize: 18)),
                      ),
                      pw.Padding(
                        padding: pw.EdgeInsets.fromLTRB(1, 4, 1, 4), // Kiri: 1, Top: 4, Kanan: 1, Bottom: 4
                        child: pw.Text(':', style: pw.TextStyle(fontSize: 18)),
                      ...
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(4.0),
                        child: pw.Text('${label.username}', style: pw.TextStyle(fontSize: 18)),
                      ),
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(4.0),
                        child: pw.Text('', style: pw.TextStyle(fontSize: 18)),
                ...
                children: [
                  pw.TableRow(
                    children: [
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(4.0),
                        child: pw.Text('No KB', style: pw.TextStyle(fontSize: 18)),
                      ),
                      pw.Padding(
                        padding: pw.EdgeInsets.fromLTRB(1, 4, 1, 4), // Kiri: 1, Top: 4, Kanan: 1, Bottom: 4
                        child: pw.Text(':', style: pw.TextStyle(fontSize: 18)),
                      ...
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(4.0),
                        child: pw.Text(
                          '${label.noKayuBulat} / ${label.nmSupplier} - ${label.noTruk}',
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Align(
                    ...
                    child: pw.Container(
                      margin: pw.EdgeInsets.only(left: 25), // Menambahkan margin kiri sebesar 20
                              ...
                              pw.TableRow(
                                children: [
                                  pw.Padding(
                                    ...
                                    child: pw.Align(
                                      alignment: pw.Alignment.centerRight, // Mengatur teks ke align right
                                      child: pw.Text('Ton', style: pw.TextStyle(fontSize: 22)),
                                    ),
                                  ),
                                  pw.Padding(
                                    padding: pw.EdgeInsets.fromLTRB(1, 4, 1, 4), // Kiri: 1, Top: 4, Kanan: 1, Bottom: 4
                                  ...
                                  pw.Padding(
                                    ...
                                    child: pw.Align(
                                      alignment: pw.Alignment.centerLeft, // Mengatur teks ke align right
                                      child: pw.Text('${label.total.ton}', style: pw.TextStyle(fontSize: 22)),
                                    ),
                                  ),
                                ],
                              ),
              ...
              pw.Container(
                ...
                pw.Container(
                  ...
                  margin: pw.EdgeInsets.only(top: -100), // Mengatur margin top sebesar 10
                  child: pw.Text(
                    label.isSLP ? 'SLP' : '', // Jika `isslp` true, tampilkan 'SLP', jika false tampilkan string kosong
                    style: pw.TextStyle(
                      fontSize: 30,
                      fontWeight: pw.FontWeight.bold,
                    ),
